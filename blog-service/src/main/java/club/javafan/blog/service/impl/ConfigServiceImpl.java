...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String WEBSITE_DESC = "币圈豆子哥是SpringBoot2+Thymeleaf+Mybatis建造的个人博客网站.SpringBoot实战博客源码.个人博客搭建";
    ...
    public static final String NAME = "币圈豆子哥";

    public static final String ABOUT = "世上本没有bug,写的人多了也便成了bug";
    public static final String ICP = "冀ICP备 xxxxxx-x号";
    public static final String COPY_RIGHT = "@2020 币圈豆子哥";
    public static final String POWER_BY = "币圈豆子哥";
