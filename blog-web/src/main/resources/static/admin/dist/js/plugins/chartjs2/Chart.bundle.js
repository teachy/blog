...
// date from string and format string
                function configFromStringAndFormat(config) {
                    ...
                    for (i = 0; i < tokens.length; i++) {
                        ...
                        //         'regex', getParseRegexForToken(token, configs));
                        if (parsedInput) {
...
// DEPRECATIONS
            ...
            module.exports = function (Chart) {
                ...
                /**
                 * Initializes the given configs with global and chart default values.
                 */
                ...
                /**
                 * Updates the configs of the chart
                ...
                helpers.extend(Chart.prototype, /** @lends Chart */ {
                    ...
                    construct: function (item, config) {
                        ...
                        // Define alias to the configs data: `chart.data === chart.configs.data`
                ...
                helpers.configMerge = function (/* objects ... */) {
                    return helpers.merge(helpers.clone(arguments[0]), [].slice.call(arguments, 1), {
                        merger: function (key, target, source, options) {
                            ...
                            if (key === 'scales') {
                                // scale configs merging is complex. Add our own function here for that
...
// DEPRECATIONS
             ...
             * since responsiveness is handled by the controller.resize() method. The configs is used
...
// @TODO Make possible to select another platform at build time.
            ...
            module.exports = function (Chart) {
                ...
                // Default configs for a category scale
                var defaultConfig = {
                    position: 'bottom'
                };
